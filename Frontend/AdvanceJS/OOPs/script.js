...
//Ans : The code become really big and it occupy much greater space instead can use class to avoid our code look messy...
...
//     },
//     upgrade: function(){
//         let updrage = (this.price*15)/100
//         this.price += updrage;
//         console.log(`Increased Price : ${this.price}`)
//     },
// }
...
//Ans: Class is taking much less space, code looks clean, scalable and more manageable.
...
//     }
// }
// let e1 = new Employee("Ansh", 90000)
// let e2 = new Employee("Aryan", 300000)
// let e3 = new Employee("Abhilasha", 120000)
...
//Ans: bcz i have created as prototye and make sure to deposit in ba1
...
// let ba1 = new BankAccount("Aryan", 12000)
// let ba2 = new BankAccount("Ayush", 2000)
...
//Ans: Space kaam lega agar suppose crores of user hue toh memory kafi jada hojayegi isliye shared memory
// function Vehicle(type, wheels){
//     this.type = type
//     this.wheels = wheels
// }
// Vehicle.prototype.fnc = function(){
//     console.log(this.type,"-",this.wheels);
//     console.log(this);
// }

// let v1 = new Vehicle("BallGadi", 2);
// let v2 = new Vehicle("Alto", 4);
// let v3 = new Vehicle("HawiGahaz", 2);
...
//Ans: Bss parameter extra add hoagye hai nothing else
...
// 	29.	Call the bind function later and observe the output.
// 	30.	Explain why bind is useful when functions are executed later or inside callbacks.
//Ans: Bcz fxn are created isliye ki haam usse kahi bhi call kar sake aapne need ki hisabh se isliye bind ke pas upper edge compared to call,apply
let obj = {
    name : "Aryan"
}
function greet(){
